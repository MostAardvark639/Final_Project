...
// }
	 if (poses.length > 0) {
	 	...
	 	push()
	 	imageMode(CENTER)
	 	image(SPIDEY_MASK_PNG, poses[0].pose.nose.x, poses[0].pose.nose.y, (poses[0].pose.leftEar.x + poses[0].pose.rightEar.x) / 2, (poses[0].pose.leftEar.x + poses[0].pose.rightEar.x) / 2 )
	 	pop()
		// print(poses[0].pose)
